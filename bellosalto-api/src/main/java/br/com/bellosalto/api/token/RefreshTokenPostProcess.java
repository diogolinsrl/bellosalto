package br.com.bellosalto.api.token;
...
public class RefreshTokenPostProcess implements ResponseBodyAdvice<OAuth2AccessToken> {
	...
	public OAuth2AccessToken beforeBodyWrite(OAuth2AccessToken body, MethodParameter returnType,
		...
		adicionarRefreshTokenoNoCookie(refreshToken, req, resp);
	...
	private void adicionarRefreshTokenoNoCookie(String refreshToken, HttpServletRequest request,
			HttpServletResponse response) {
		Cookie refreshTokenCookie = new Cookie("refreshToken", refreshToken);
		refreshTokenCookie.setHttpOnly(true);
		refreshTokenCookie.setSecure(belloSaltoApiProperty.getSeguranca().isEnableHttps());
